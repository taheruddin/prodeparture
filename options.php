...
function optionsframework_options() {
	...
	$typography_options = array(
		...
		'styles' => array( 'normal' => 'Normal', 'bold' => 'Bold', 'italic' => 'Italic', 'italic-bold' => 'Italic Bold' ),
		'color' => true
	);
...
/* ------------------------------------------------------------------------------------------------------------------------------------------------ */
	...
	$options[] = array(
	'name' => __('Display options', 'starbase'),
	'type' => 'heading');
	...
	$options[] = array(
	'name' => __('Site Logo', 'starbase'),
	'desc' => __('PNG is recommended format.', 'starbase'),
	'id' => 'site-logo',
	'type' => 'upload');
	
	$options[] = array(
	'name' => __('Hide header text', 'greengame'),
	'desc' => __('Hide site title and moto in header, default is unchecked.', 'starbase'),
	'id' => 'hide-header-text',
	'std' => '0',
	'type' => 'checkbox');
	...
	/*		
	$options[] = array(
	'name' => __('Footer Text', 'starbase'),
	'desc' => __('Text to be shown in footer.', 'starbase'),
	'id' => 'footer-text',
	'std' => '&copy; Pascual Madrigal All Rights Reserved',
	'type' => 'textarea');
	*/
	
	$options[] = array(
	'name' => __('Footer Content', 'starbase'),
	'desc' => __( 'Enter HTML content to show in footer.' ),
	'class' => 'block0',
	'id' => 'footer-html',
	'type' => 'editor',
	'settings' => $wp_editor_settings );
...
/*	
	$options[] = array(
	'name' => __('Block-30', 'theme_name'),
	'desc' => __('Enter html here', 'options_check'),
	'id' => 'block-30',
	'std' => 'Default Text',
	'type' => 'textarea');
*/	
	/* How to recall option values in theme */
	//echo of_get_option('block-0');
	//echo of_get_option('block-1');
